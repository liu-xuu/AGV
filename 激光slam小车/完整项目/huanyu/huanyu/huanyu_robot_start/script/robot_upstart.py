...
if __name__ == '__main__':
    ...
    basDir = "/home/huike/"
    logging.basicConfig(filename='/home/huike/Documents/robot_upstart.log',filemode="w",format="%(asctime)s %(name)s:%(levelname)s:%(message)s",datefmt="%d-%M-%Y %H:%M:%S",level=logging.INFO)
